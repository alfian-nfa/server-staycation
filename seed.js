...
seeder.connect(
  ...
  function () {
    ...
    seeder.loadModels(["./models/Category", "./models/Bank", "./models/Item", "./models/Feature", "./models/Activity", "./models/Image", "./models/Member", "./models/Booking", "./models/Users"]);
    ...
    documents: [
      {
        ...
        firstName: "Alfian",
        lastName: "Azis",
        emailAddress: "alfian.azis95@gmail.com",
        phoneNumber: "082246336730",
      },
      {
        _id: mongoose.Types.ObjectId("5e96cbe292b97300fc903334"),
        firstName: "Elfin",
        lastName: "Narayana",
        emailAddress: "elfinnarayana1020@gmail.com",
        phoneNumber: "082246336730",
      },
    ],
  },
